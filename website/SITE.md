...
- **Tech Stack:** Starlight / Astro (Transitioning to bespoke Stitch HTML components where necessary)
...
## 6. Creative Freedom
If roadmap tasks are exhausted, design sub-elements for the landing page (a dynamic terminal mock up showing the CLI, or a visual diagram of FTS5 + Vec search).
