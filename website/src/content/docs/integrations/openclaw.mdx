...
3. ### Initialize a vault and collections
   ...
   The file watcher runs automatically inside `quaid serve`. A persistent background daemon is available via `quaid daemon install` in `v0.21.0` (the current published release).
