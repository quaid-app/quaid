...
3. ### Initialize a vault and collections
   ...
   The file watcher runs automatically inside `quaid serve`. A persistent background daemon is available via `quaid daemon install` in the current published release (`v0.23.0`).
