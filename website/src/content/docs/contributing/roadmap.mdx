...
**Latest published release:** `v0.23.0`. **Main branch manifest:** `v0.23.0` in `Cargo.toml`.

That means the remaining items below are roadmap work or branch-only follow-ons beyond the current `v0.23.0` release lane.
</Aside>
