...
> All commands are implemented. Build from source or download a pre-built binary from GitHub Releases (`v0.9.1`). See [Install & Status](/guides/install/) for details.
