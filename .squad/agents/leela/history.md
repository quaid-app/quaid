...
- [2026-05-15T10:21:41.579+00:00] COMPLETED: Reconciled housekeeping issue shortlist against current checkout + public GitHub state, marked the future-scope task complete, and logged the unauthenticated GitHub write blocker for #135/#203/#197/#196/#73
...
- 2026-05-14T10:44:54.579+00:00 — **Remote branch pruning gate:** Only auto-delete remote branches whose exact tip SHA is already an ancestor of `origin/main`. If a branch is still ahead of main, route it for owner review instead of treating the name as evidence that it is dead.
- 2026-05-14T10:44:54.579+00:00 — **Housekeeping batch scope rule:** When roadmap truth repair, issue reconciliation, branch pruning, and a patch release must move together, open a dedicated operational OpenSpec change instead of smuggling the work under an unrelated feature lane.
- 2026-05-14T10:44:54.579+00:00 — **Key housekeeping files:** public roadmap truth lives in `docs/roadmap_v3.md` and `website/src/content/docs/contributing/roadmap.mdx`; release truth gates live in `Cargo.toml`, `.github/workflows/release.yml`, and `.github/release-assets.txt`; contradiction-truth docs currently diverge in `website/src/content/docs/how-to/contradictions-and-gaps.mdx`.
