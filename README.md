...
- **Hybrid retrieval** — FTS5 full-text + local vector embeddings, combined via RRF
...
# Import an existing markdown directory (respects PARA folder structure)
...
Inspired by [Garry Tan's compiled knowledge model](https://gist.github.com/garrytan/49c88e83cf8d7ae95e087426368809cb). Quaid takes the same architecture — SQLite + FTS5 + vectors + MCP + fat skills — and builds it in Rust for a fully local, zero-dependency binary.
