...
**Latest published release:** `v0.22.3`. **Main branch manifest:** `v0.22.3` in `Cargo.toml`.
...
<CardGrid>
  <Card title="Frontmatter and wikilink autowiring" icon="check-circle">
    ...
    `links:`, `parent:`, `children:`, `related:`, and body `[[slug]]` references now create derived graph edges automatically. The current published release (`v0.22.3`) carries this foundation.
