...
3. ### Initialize a vault and collections
   ...
   The file watcher runs automatically inside `quaid serve`. A persistent background daemon will be available via `quaid daemon install` in the upcoming `v0.21.0` release — not yet published.
